import { update, callTag } from "../../../services/api-tag";
...
export const UpdateTag = () => {
    ...
    const [tag, setTagid] = useState({ name: '', tag: '' });
    useEffect(() => {
        const fetchTag = async () => {
                const res = await callTag(id);
        ...
        <div className="main-content">
            ...
            <form onSubmit={handSubmit} className="max-w-sm mt-5" method="post">
                <div className="mb-5">
                    ...
                    <input type="name" name="name" id="name" value={tag.name}  onChange={(e) => setTagid({ ...tag, name: e.target.value })} className="shadow-sm bg-gray-50 border border-gray-300 text-gray-800 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-100 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" required />
                </div>
